USE [TTQK7]
GO
/****** Object:  StoredProcedure [dbo].[sp_Thanh_BaoCaoThang]    Script Date: 3/16/2021 11:24:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER procedure [dbo].[sp_Thanh_BaoCaoThang]
@thang int, @nam int
as 
begin
	...
	from dbo.BaoCaoNgay, dbo.tblDonVi
	where dbo.BaoCaoNgay.DonViID = dbo.tblDonVi.DonViID
	and month(dbo.BaoCaoNgay.NgayBaoCao)= @thang
	and year(dbo.BaoCaoNgay.NgayBaoCao)= @nam
	and dbo.tblDonVi.ParentID is null
	--bang A1
	union all
	SELECT   dbo.BaoCaoNgay.NgayBaoCao, dbo.TBBD_A1.CanhBTTM AS TBBD_A1_CanhBTTM, dbo.TBBD_A1.CanhBTTM_Dut AS TBBD_A1_CanhBTTM_Dut,
                         dbo.TBBD_A1.CanhQK AS TBBD_A1_CanhQK, dbo.TBBD_A1.CanhQK_Dut AS TBBD_A1_CanhQK_Dut, dbo.TBBD_A1.Lanphatchuan AS TBBD_A1_Lanphatchuan, dbo.TBBD_A1.ThuTinHieuBo AS TBBD_A1_ThuTinHieuBo, 
                         dbo.TBBD_A1.ThuTinHieuQK AS TBBD_A1_ThuTinHieuQK, dbo.TBBD_A1.QKPhatTinHieu AS TBBD_A1_QKPhatTinHieu, 
						 0 AS DonBien_A2_SoDoiTuong, 0 AS DonBien_A2_TongSoPhien, 0 AS DonBien_A2_TongSoPhien_Dut, 0 AS DonBien_A2_SoPhienCT, 
                         0 AS DonBien_A2_SoPhienCT_Dut, 0 AS DonBien_A2_DienS, 0 AS DonBien_A2_DienT, 
                         0 AS SongNgan_BTTM_A3_TongSoPhien, 0 AS SongNgan_BTTM_A3_TongSoPhien_Dut, 
                         0 AS SongNgan_BTTM_A3_GoiCanh, 0 AS SongNgan_BTTM_A3_GoiCanh_Dut, 0 AS SongNgan_BTTM_A3_TraLoiCanh, 
